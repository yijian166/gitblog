...
<div class="code-box">
	...
	<p><strong>网格</strong>,包括横向和纵向网格，网格可以使得你的网站所有元素对齐，且富有韵律。在此有几个[值得推荐](http://vandelaydesign.com/blog/design/resources-grid-based-design/)，在近几年流行的网格可以使用，你可以选择其中的一种或者创建你自己的网格，只要适合你的项目即可。</p>
