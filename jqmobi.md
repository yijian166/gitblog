...
手机中web view和浏览器毕竟还是有区别，因此一个调试工具就非常有必要，在此推荐lynn的[weinre教程](http://blog.i-buffer.com/entry/weinre-tutorial),里面有详细的配置教程，甚至还有打包好的一键开启工具下载。还有[这个](http://segmentfault.com/a/1190000000459296)。
